            ...
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    {isAuthenticated ? (
                        ...
                        <Link to="/admin/login" className="flex items-center gap-2 text-gray-400 hover:text-primary transition-colors">
                    ...
                    >
                        <div className="flex flex-col p-6 gap-4">
                            ...
                            {isAuthenticated ? (
                                ...
                                <Link to="/admin/login" onClick={() => setIsOpen(false)} className="text-gray-400 p-2 flex items-center gap-2">
