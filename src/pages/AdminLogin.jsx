        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-bg-main">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-text-secondary">Enter your credentials to access the admin panel.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="relative group">
                        <User className="absolute left-3 top-3.5 text-text-muted group-focus-within:text-primary transition-colors" size={20} />
                        <input
                            type="text"
                            value={username}
                            onChange={(e) => setUsername(e.target.value)}
                            className="w-full bg-bg-main border border-border-main rounded-xl py-3 pl-10 pr-4 text-text-primary focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all"
                            placeholder="Username"
                        />
                    </div>
                    <div className="relative group">
                        <Lock className="absolute left-3 top-3.5 text-text-muted group-focus-within:text-primary transition-colors" size={20} />
                        <input
                            type="password"
                            value={password}
                ...
                <div className="mt-8 text-center">
                    <a href="/" className="text-sm text-text-muted hover:text-primary transition">Return to Home</a>
                </div>
            </motion.div>
        </div>
    );
